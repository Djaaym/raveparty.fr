...
export const EDITIONS: Record<string, EditionRef[]> = {
  ...
  "dominator-festival": [{ y: "2026", end: "2026-07-17", base: "festival" }, { y: "2027", end: "2027-07-16", base: "festival" }],
  "dour-festival": [{ y: "2026", end: "2026-07-15", base: "festival" }, { y: "2027", end: "2027-07-11", base: "festival" }],
  "flow-festival": [{ y: "2026", end: "2026-08-16", base: "festival" }, { y: "2027", end: "2027-08-15", base: "festival" }],
  ...
  "kamping-kitsch-club": [{ y: "2026", end: "2026-08-22", base: "festival" }, { y: "2027", end: "2027-08-21", base: "festival" }],
  ...
  "solar-weekend-festival": [{ y: "2026", end: "2026-08-02", base: "festival" }, { y: "2027", end: "2027-08-01", base: "festival" }],
  sonar: [{ y: "2026", end: "2026-06-18", base: "festival" }, { y: "2027", end: "2027-06-19", base: "festival" }],
  "sunrise-festival-kolobrzeg": [{ y: "2026", end: "2026-08-02", base: "festival" }, { y: "2027", end: "2027-08-01", base: "festival" }],
  "sziget-festival": [{ y: "2026", end: "2026-08-15", base: "festival" }, { y: "2027", end: "2027-08-14", base: "festival" }],
  ...
  wecandance: [{ y: "2026", end: "2026-08-16", base: "festival" }, { y: "2027", end: "2027-08-15", base: "festival" }],
};
/* EDITIONS:end */
